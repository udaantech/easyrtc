...
function reshapeToFullSize(parentw, parenth) {
    ...
    left = (parentw-parentw+margin);
    top = (parenth-parenth+margin);
    return {
        left:left,
        top:top,
        width: parentw / 3 - 80,
...
function reshape2of2(parentw, parenth){
    if( layout== 'p' ) {
        ...
        return{
            left: (parentw-parentw+margin+(parentw * .3)+margin),
            top:  (parenth-parenth+margin),
            width: parentw / 3 - 80,
            height: parenth / 2 - 60
        }
...
function reshape1of3(parentw, parenth) {
    ...
    if( layout== 'p' ) {
        ...
        return{
            left: (parentw-parentw+margin+margin),
            top:  (parenth-parenth),
            width: parentw / 3,
            height: parenth / 2
        }
...
function reshape2of3(parentw, parenth){
    ...
    if( layout== 'p' ) {
        ...
        return{
            left: (parentw-parentw+margin+(parentw * .3)+margin+margin),
            top:  (parenth-parenth),
            width: parentw / 3,
            height: parenth / 2
        }
...
function reshape3of3(parentw, parenth) {
    ...
    if( layout== 'p' ) {
        ...
        return{
            left: (parentw-parentw+margin+(parentw * .3)+margin+(parentw * .3)+margin+margin),
            top:  (parenth-parenth),
            width: parentw / 3,
            height: parenth / 2
        }
...
function reshape2of4(parentw, parenth) {
    return {
        left: (parentw-parentw+margin+sharedVideoWidth+margin),
        top: (parenth-sharedVideoHeight)/2,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function reshape3of4(parentw, parenth) {
    return {
        left: (parentw-parentw+margin+sharedVideoWidth+margin+sharedVideoWidth+margin),
        top: (parenth-sharedVideoHeight)/2,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function reshape4of4(parentw, parenth) {
    return {
        left: (parentw-parentw+margin+sharedVideoWidth+margin+sharedVideoWidth+margin+sharedVideoWidth+margin),
        top: (parenth-sharedVideoHeight)/2,
        width: sharedVideoWidth,
        height: sharedVideoHeight
    }
...
function appInit() {
    ...
    //document.getElementById("chat").style.left="200px";
